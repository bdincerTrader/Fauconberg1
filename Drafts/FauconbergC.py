...
class Gr8Scriptd9f9ff1eb4b545529bca9a976e207331(Strategy):
    __script_name__ = 'FauconbergTwo'
    ...
    def is_symbol_qualified(cls, symbol, md, service, account):
        ...
        return symbol in Gr8Scriptd9f9ff1eb4b545529bca9a976e207331.tickerItrB;
    ...
    def on_start(self, md, order, service, account):
        ...
        ## reverse engineer the allocation process and unload accordingly.    
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        ### sself.chkMktSystem==2 and case the position shares vs. pending.
        ### sself.chkMktSystem==2 and case the position shares vs. pending.
        ### sself.chkMktSystem==2 and case the position shares vs. pending.
                            ...
                            if(dmp>self.__class__.cycl and abs(account[self.symbol].position.capital_long)<self.riskAllowance*10 and len(account[self.symbol].pending.orders)<10 and self.quvantity>0):
                                ...
                                if(self.orderECN==1 and abs(account[self.symbol].position.capital_long)<self.riskAllowance*10):
                                    ...
                                    if(self.allocated[-1]>self.allocated[-2]):
                                        ...
                                        # dos dos.
                                        riskUnitZero = order.algo_buy(self.symbol, algorithm='4ad20d14-aacb-4850-9efe-cfa92d154304', intent='increase', order_quantity=max(bidQty,1), price=zeroPx, user_key=111, allow_multiple_pending=40);
    ...
    def on_fill(self, event, md, order, service, account):
        # TODO
        # ADJUST USER KEY FOR MKT ORDER DOUBLE THING.
        # PUT IT INTO AN ARRAY.
        # POP IT ON THE OFFER STACK.
        # *** consolidate the offer into fewer pieces.
        # DISCARD ARRAY.
