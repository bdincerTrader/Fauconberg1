...
class gaspardata(Strategy):
    __script_name__ = 'gaspardataMS750'
    ...
    def on_start(self, md, order, service, account):
        ...
        self.dataBookMSB =[[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]
        self.dataBookMSC =[[],[],[],[],[],[],[],[],[],[],[],[],[]]
        service.add_time_trigger(md.market_open_time + service.time_interval(minutes=45), repeat_interval=service.time_interval(minutes=10), timer_id="Allocate")
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        for idx in range(0, rangeM, 1):
            ...
            self.dataBookMS[self.itr][1]=idx;
            ...
            if(self.idxLoop>10 and idx==rangeM-1):
                ...
                # PUT IN COMP.
                if(self.dataPt[-1][20]==self.dataBookMS[self.itr][148]):
                    self.dataBookMS[self.itr][150]=1;
                elif(self.dataPt[-1][20]==self.dataBookMS[self.itr][149]):
                    self.dataBookMS[self.itr][151]=-1;                  
                if(self.dataPt[-1][19]==self.dataBookMS[self.itr][137]):
                    self.dataBookMS[self.itr][152]=1;
                elif(self.dataPt[-1][19]==self.dataBookMS[self.itr][138]):
                    self.dataBookMS[self.itr][153]=-1;
                if(self.dataPt[-1][18]==self.dataBookMS[self.itr][126]):
                    self.dataBookMS[self.itr][154]=1;
                elif(self.dataPt[-1][18]==self.dataBookMS[self.itr][127]):
                    self.dataBookMS[self.itr][155]=-1;
                if(self.dataPt[-1][17]==self.dataBookMS[self.itr][115]):
                    self.dataBookMS[self.itr][156]=1;
                elif(self.dataPt[-1][17]==self.dataBookMS[self.itr][116]):
                    self.dataBookMS[self.itr][157]=-1;
                if(self.dataPt[-1][14]==self.dataBookMS[self.itr][104]):
                    self.dataBookMS[self.itr][158]=1;
                elif(self.dataPt[-1][14]==self.dataBookMS[self.itr][105]):
                    self.dataBookMS[self.itr][159]=-1;
                if(self.dataPt[-1][10]==self.dataBookMS[self.itr][93]):
                    self.dataBookMS[self.itr][160]=1;
                elif(self.dataPt[-1][10]==self.dataBookMS[self.itr][94]):
                    self.dataBookMS[self.itr][161]=-1; 
                if(self.dataPt[-1][9]==self.dataBookMS[self.itr][82]):
                    self.dataBookMS[self.itr][162]=1;
                elif(self.dataPt[-1][9]==self.dataBookMS[self.itr][83]):
                    self.dataBookMS[self.itr][163]=-1;
                if(self.dataPt[-1][15]==self.dataBookMS[self.itr][71]):
                    self.dataBookMS[self.itr][164]=1;
                elif(self.dataPt[-1][15]==self.dataBookMS[self.itr][72]):
                    self.dataBookMS[self.itr][165]=-1;
                if(self.dataPt[-1][16]==self.dataBookMS[self.itr][60]):
                    self.dataBookMS[self.itr][166]=1;
                elif(self.dataPt[-1][16]==self.dataBookMS[self.itr][61]):
                    self.dataBookMS[self.itr][167]=-1;
                if(self.dataPt[-1][8]==self.dataBookMS[self.itr][48]):
                    self.dataBookMS[self.itr][168]=1;
                elif(self.dataPt[-1][8]==self.dataBookMS[self.itr][49]):
                    self.dataBookMS[self.itr][169]=-1;
                if(self.dataPt[-1][6]==self.dataBookMS[self.itr][37]):
                    self.dataBookMS[self.itr][170]=1;
                elif(self.dataPt[-1][6]==self.dataBookMS[self.itr][38]):
                    self.dataBookMS[self.itr][171]=-1;
                if(self.dataPt[-1][7]==self.dataBookMS[self.itr][26]):
                    self.dataBookMS[self.itr][172]=1;
                elif(self.dataPt[-1][7]==self.dataBookMS[self.itr][27]):
                    self.dataBookMS[self.itr][173]=-1;
                ...
                for bIdx in range(-2, -10, -1):
                    if(self.dataPt[bIdx][6]>self.dataPt[bIdx-1][6]):
                        chkB[0]+=1;
                    if(self.dataPt[bIdx][7]>self.dataPt[bIdx-1][7]):
                        chkB[1]+=1;
                    if(self.dataPt[bIdx][8]>self.dataPt[bIdx-1][8]):
                        chkB[2]+=1;
                    if(self.dataPt[bIdx][14]>self.dataPt[bIdx-1][14]):
                        chkB[3]+=1;
                    if(self.dataPt[bIdx][15]>self.dataPt[bIdx-1][15]):
                        chkB[4]+=1;
                    if(self.dataPt[bIdx][16]>self.dataPt[bIdx-1][16]):
                        chkB[5]+=1;
                    if(self.dataPt[bIdx][17]>self.dataPt[bIdx-1][17]):
                        chkB[6]+=1;
                    if(self.dataPt[bIdx][18]>self.dataPt[bIdx-1][18]):
                        chkB[7]+=1;  
                    if(self.dataPt[bIdx][19]>self.dataPt[bIdx-1][19]):
                        chkB[8]+=1;
                    if(self.dataPt[bIdx][20]>self.dataPt[bIdx-1][20]):
                        chkB[9]+=1;     
