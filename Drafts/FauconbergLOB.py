# Editor
# FauconbergBandsLOB   BDincer   8/9/2023 7:29:57 AM   QA-2.0.205
...
class Gr8Script17b09ac5f7834bbcba0a0f40e2eb1ec5(Strategy):
    __script_name__ = 'FauconbergBandsLOB'
    ...
    def on_start(self, md, order, service, account):
        ...
        #self.__class__._temp_string += '%s,%s,%s,%s \n' % (service.time_to_string(event.timestamp), event.timestamp, self.symbol, self.safetySymbol)
        service.write_file(self.file_name , self.symbol, mode = 'append', path = {'FORWARD': '/mnt/userdata/bdincer/', 'PRODUCTION': '/mnt/userdata/bdincer/' });
        
        #self.file_name="/mnt/userdata/bdincer/";
        #self.filetest='\\\EQKTG02'+'\\bdincer'+self.symbol+service.time_to_string(service.system_time, '%Y-%m-%d')+".txt";
        #self.filetest='/mnt/userdata/jmartorella/";
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        if(event.timer_id=="Review"):
            ...
            self.chkTrajectoryQ.append( float((self.qqqBid - self.qqqPrior+0.00001) /self.qqqPrior));
            self.chkTrajectoryS.append( float( (self.spyBid - self.spyPrior+0.00001) /self.spyPrior));
            #IF THE SYSTEM DOESNT HAVE INFORMATION- IT IS BROKEN. SO THE PROGRAM WILL SHUT DOWN.
            ...
            chkPt="";
            chkPt=str(self.itr)+"," + str(self.symbol)+"," + str(service.time_to_string(service.system_time))+"," + str(service.time_to_string(service.system_time))+","+str(md.L1.bid)+"," + str(md.L1.ask)+"," + str(md.L1.last)+","+str(self.midPrice)+"," + str(self.pxChg)+"," + str(self.tkrRate[-1])+"," + str( self.chkTrajectoryQ[-1])+","+str(self.chkTrajectoryS[-1])+"," + str(self.trajectoryBook[-1])+"," + str(self.trajectoryBid[-1])+"," + str(self.trajectoryAsk[-1])+",";
            chkPt+=str(self.qqqBid)+"," +str(self.spyBid)+"," +str(self.qqqPrior)+"," +str(self.spyPrior)+",";
            chkPt+=str(self.midPrice)+"," + str(self.pxChg)+"," + str(self.tkrRate[-1])+"," + str( self.chkTrajectoryQ[-1])+","+str(self.chkTrajectoryS[-1])+"," + str(self.trajectoryBook[-1])+"," + str(self.trajectoryBid[-1])+"," + str(self.trajectoryAsk[-1])+","+str(self.trajectoryLast[-1])+"," + str(self.trajectorySpread[-1])+"," + str(self.pxTrajectory[-1])+"," + str(self.allocated[-1])+","+str(self.ID_RB1[-1][0])+"," + str(self.ID_RB1[-1][1])+"," + str(self.ID_RB1[-1][4])+"," + str(self.ID_RB1[-1][5])+"," + str(self.ID_RB1[-1][6])+"," + str(self.ID_RB1[-1][7])+",";
            chkPt+=str(self.ID_RB1[-1][8])+","+ str(self.ID_RB1[-1][9])+","+str(self.ID_RB1[-1][10])+","+str(self.safetySymbol)+","+str(self.allocator)+","+str(self.sizeAgg)+","+str(self.gates[-1][0])+"," + str(self.gates[-1][1])+","+ str(self.gates[-1][2])+",";
            chkPt+=str(self.gates[-1][3])+"," + str(self.gates[-1][4])+",";str(self.gates[-1][5])+"," + str(self.gates[-1][6])+",";
            chkPt+=str(self.gates[-1][7])+"," + str(self.gates[-1][8])+"," + str(self.gates[-1][9])+"," + str(self.gates[-1][10])+"," + str(self.demand[-1][1])+"," + str(self.demand[-1][2])+",";
            chkPt+=str(self.demand[-1][3])+"," + str(self.demand[-1][4])+"," + str(self.demand[-1][6])+"," + str(self.supply[-1][1])+"," + str(self.supply[-1][2])+"," + str(self.supply[-1][3])+",";
            chkPt+=str(self.supply[-1][4])+"," + str(self.supply[-1][6])+"," + str(self.chkMin)+"," + str(self.chkMinPt)+"," + str(self.chkMax)+"," + str(self.chkMaxPt)+"," + str(self.ID_R1[-1])+",";
            chkPt+=str(self.chkHop[-1][0])+"," + str(self.chkHop[-1][1])+"," + str(self.chkHop[-1][2])+"," + str(self.RBCT_PRIME[-1][0])+"," + str(self.RBCT_PRIME[-1][1])+"," + str(self.RBCT_PRIME[-1][2])+"," + str(self.RBCT_PRIME[-1][3])+"," + str(self.ID_R3[-1][0])+",";
            chkPt+=str(self.ID_R3[-1][1])+","+str(self.ID_R3[-1][2])+"," + str(self.ID_R3[-1][3])+","+str(self.ID_R3[-1][4])+","+str(self.ID_R3[-1][5])+","+str(self.ID_R3[-1][6])+","+str(self.ID_R3[-1][7])+","+str(self.ID_R3[-1][8])+",";
            chkPt+=str(self.ID_R3[-1][9])+","+ str(account.buying_power)+"," + str(account[self.symbol].position.shares)+"," + str(account[self.symbol].position.mtm_price)+"," + str(account[self.symbol].unrealized_pl.entry_pl)+","+str(account[self.symbol].realized_pl.entry_pl)+"," + str( account[self.symbol].pending.count_long)+"," + str(account[self.symbol].pending.shares_long)+"," + str( account[self.symbol].pending.capital_long)+"," + str( account[self.symbol].pending.count_short)+"," + str(account[self.symbol].pending.shares_short)+"," + str(account[self.symbol].pending.capital_short);
            service.write_file(self.filetestC , chkPt, mode = 'append', path = {'FORWARD': '/mnt/userdata/bdincer/', 'PRODUCTION': '/mnt/userdata/bdincer/' });
        ...
        if(event.timestamp>self.liquid_time and event.timestamp<self.illiquid_time and self.allocator>1 and self.RBCT_PRIME[-1][3]==1 and self.postUnit>0):
            ...
            if(self.ID_RB1[-1][6]==1):
                ...
                #self.orderBook.append([self.itr, self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][5], self.demand[-1][6], 1]);
                #service.write_file(self.filetestB,'{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}'.format(self.itr, self.symbol, service.time_to_string(service.system_time), service.time_to_string(service.system_time),md.L1.bid,md.L1.ask,md.L1.last,self.midPrice, self.chkTrajectoryQ[-1], self.chkTrajectoryS[-1], self.trajectoryBook[-1], self.trajectoryBid[-1], self.trajectoryAsk[-1], self.trajectoryLast[-1], self.trajectorySpread[-1], self.pxTrajectory[-1], self.allocated[-1], 1, self.demand[-1][1], self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][6],  self.supply[-1][6], self.supply[-1][4],  self.supply[-1][3], self.supply[-1][2], self.supply[-1][2], self.marketDepth[0][0], self.marketDepth[0][1], self.marketDepth[0][2]));
                pass;
                ...
                #self.orderBook.append([self.itr, self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][5], self.demand[-1][6], 2]);
                #service.write_file(self.filetestB,'{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}'.format(self.itr, self.symbol, service.time_to_string(service.system_time), service.time_to_string(service.system_time),md.L1.bid,md.L1.ask,md.L1.last,self.midPrice, self.chkTrajectoryQ[-1], self.chkTrajectoryS[-1], self.trajectoryBook[-1], self.trajectoryBid[-1], self.trajectoryAsk[-1], self.trajectoryLast[-1], self.trajectorySpread[-1], self.pxTrajectory[-1], self.allocated[-1], 2, self.demand[-1][1], self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][6],  self.supply[-1][6], self.supply[-1][4],  self.supply[-1][3], self.supply[-1][2], self.supply[-1][2], self.marketDepth[1][0], self.marketDepth[1][1], self.marketDepth[1][2]));
                pass;
                ...
                #service.write_file(self.filetestB,'{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}'.format(self.itr, self.symbol, service.time_to_string(service.system_time), service.time_to_string(service.system_time),md.L1.bid,md.L1.ask,md.L1.last,self.midPrice, self.chkTrajectoryQ[-1], self.chkTrajectoryS[-1], self.trajectoryBook[-1], self.trajectoryBid[-1], self.trajectoryAsk[-1], self.trajectoryLast[-1], self.trajectorySpread[-1], self.pxTrajectory[-1], self.allocated[-1], 3, self.demand[-1][1], self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][6],  self.supply[-1][6], self.supply[-1][4],  self.supply[-1][3], self.supply[-1][2], self.supply[-1][2],  self.marketDepth[2][0], self.marketDepth[2][1], self.marketDepth[2][2]));
                #self.orderBook.append([self.itr, self.demand[-1][2], self.demand[-1][3], self.demand[-1][4], self.demand[-1][5], self.demand[-1][6], 1]);
                pass;
            pass;
