...
# CHG 1: switched order from SOR to ARCA 'c982d0cd-9be5-4a35-b89f-1f66b2495ec4' #FOR LIMIT SELL ORDERS: line 269, 310 #FOR LIMIT BUY ORDERS: line 563
...
class Gr8Scriptbc647d165f044ffe89a4af2f179b3494(Strategy):
    __script_name__ = 'switchBox3og'
    ...
    #tickerItr = ['FCEL','ARR','LUMN', 'UEC', 'BTG','UVXY','AMC','BOIL','SWN','SIRI','KGC','NU','NOK','SPY']
