...
class Gr8Script0dda2db908c24813942b91374c7235dd(Strategy):
    __script_name__ = 'bft'
    ...
    def on_start(self, md, order, service, account):
        ...
        self.neutral=0;
        self.neutralized=0;
        self.allocationRate=0;
        self.avgAllocationRate=[];
        self.orderSession=0;
        self.orderBalance=0;
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        if(currentLocation > self.active):
            ...
            mxSpr=max(self.mktSpread);
            mnSpr=min(self.mktSpread);
            print('ATR 2 ', service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, mxSpr, mnSpr, FT,  FBT, self.ebft, self.orderBalance);
        ...
        if(self.chk_SPY > 0.02):
            ...
            print('motion5',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, mxSpr, mnSpr, FT,  FBT, self.ebft, self.orderBalance);
        ...
        if(self.chk_SPY < -0.02):
            ...
            print('motion6',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, mxSpr, mnSpr, FT,  FBT, self.ebft, self.orderBalance);
        ...
        if(self.chk_QQQ > 0.02):
            ...
            print('motion7',  service.time_to_string(service.system_time),self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, mxSpr, mnSpr, FT,  FBT, self.ebft, self.orderBalance);
        ...
        if(self.chk_QQQ < -0.02):
            ...
            mxSpr=max(self.mktSpread);
            mnSpr=min(self.mktSpread);
            print('motion8',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, mxSpr, mnSpr, FT,  FBT, self.ebft, self.orderBalance);
        ...
        if(self.key==1):
            ...
            print('ebft',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, max(self.mktSpread), min(self.mktSpread),  self.ebft,   self.ebft, self.ebft, self.orderBalance);
            ...
            if(self.ebft<0):
                ...
                print('offer',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, max(self.mktSpread), min(self.mktSpread), self.neutral, self.ebft, self.ebft+self.neutral, self.orderBalance);
            ...
            if(self.ebft>0):
                ...
                print('bid',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, max(self.mktSpread), min(self.mktSpread), self.ebft, self.neutral, self.ebft-self.neutral, self.orderBalance);
            ...
            if(self.orderSession>0 and self.ebft==0):
                ...
                #quvantity=int(self.avgAllocationRate*self.orderSession);
                QTY=0;
                if(account[self.symbol].position.shares!=0):
                    QTY=account[self.symbol].position.shares;
                else:
                    QTY=self.orderBalance;

                if(self.orderBalance>0):
                    print('sell',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, max(self.mktSpread), min(self.mktSpread), self.orderSession, self.orderBalance, QTY, self.orderBalance);
                if(self.orderBalance<0):
                    print('buy',  service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask,   self.chk_SPY, self.chk_QQQ,  currentLocation, self.__class__.spyCHG, self.__class__.qqqCHG, currentRate, max(self.mktSpread), min(self.mktSpread), self.orderSession, self.orderBalance, QTY, self.orderBalance);
                self.orderBalance=0;
