...
class Gr8Scriptcffda23257ae4d54a108e8990036b304(Strategy):
    ...
    bpRisk=50000; cycl=4; askRTE=1.0026; pxChk=0.21; plSpr=1.0005; bpMaxLoss=-bpRisk*0.20; plUnrlRTE=bpRisk*0.0010; plUpperBand=bpRisk*.01; plLowerBand=-bpRisk*.01; plBandMult=bpRisk*.01; 
