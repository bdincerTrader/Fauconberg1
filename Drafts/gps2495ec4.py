# Editor
# gpsFauconbergIndex   Baris Dincer   7/27/2023 2:06:52 AM   PROD
...
class Gr8Script4193a445a9a444cd9b5300401f29d56a(Strategy):
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        if(self.key==1 and event.timestamp<self.illiquid_time): 
            ...
            if(self.ebft>0 and (self.ATR_scRp+self.mot_scRp+self.xxl_scRp)>=4):
                self.systemLong=1;
    ...
    def on_fill(self, event, md, order, service, account):
        if(event.shares<0):
            ...
            self.netShortUnit+=1;
            print('xxxSOLD', event.shares, event.price, self.filledBuy, self.bot, self.satisfied, self.orderBalance, event.user_tag, service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask, self.chk_SPY, self.chk_QQQ,  self.__class__.spyCHG, self.__class__.qqqCHG, self.ATR_scR, self.mot_scR, self.xxl_scR, self.ATR_scRp, self.mot_scRp, self.xxl_scRp, self.priceBook[-1], (self.priceBook[-1]-self.priceBook[-2]), (self.priceBook[-1]-self.priceBook[0]), self.neutralized, self.bot, self.sold, self.neutral, self.ebft, self.orderBalance);
            pass;
        if(event.shares>0):
            self.filledBuy+=event.shares;
            print('xxxxBOT', event.shares, event.price, self.filledBuy, self.bot, self.satisfied, self.orderBalance, event.user_tag, service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask, self.chk_SPY, self.chk_QQQ,  self.__class__.spyCHG, self.__class__.qqqCHG, self.ATR_scR, self.mot_scR, self.xxl_scR, self.ATR_scRp, self.mot_scRp, self.xxl_scRp, self.priceBook[-1], (self.priceBook[-1]-self.priceBook[-2]), (self.priceBook[-1]-self.priceBook[0]), self.neutralized, self.bot, self.sold, self.neutral, self.ebft, self.orderBalance);
            pass;
        if(event.user_tag==999):
            print('xxxx999', event.shares, event.price, self.filledBuy, self.bot, self.satisfied, self.orderBalance, event.user_tag, service.time_to_string(service.system_time), self.symbol, self.zero, md.L1.bid, md.L1.last, md.L1.ask, self.chk_SPY, self.chk_QQQ,  self.__class__.spyCHG, self.__class__.qqqCHG, self.ATR_scR, self.mot_scR, self.xxl_scR, self.ATR_scRp, self.mot_scRp, self.xxl_scRp, self.priceBook[-1], (self.priceBook[-1]-self.priceBook[-2]), (self.priceBook[-1]-self.priceBook[0]), self.neutralized, self.bot, self.sold, self.neutral, self.ebft, self.orderBalance);
