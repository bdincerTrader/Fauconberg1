# Editor    SUBMISSION: UNDER_FENGER21
...
class Gr8Scriptaed62006b7a54f248d7650c7d0b3b269(Strategy):
    __script_name__ = 'underFinger2'
    ...
    def on_start(self, md, order, service, account):
        ...
        service.add_time_trigger(md.market_open_time + service.time_interval(minutes=10), repeat_interval=service.time_interval(seconds=10), timer_id="Allocate")           
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        def procPL_1():
            ...
            if(account[self.symbol].unrealized_pl.entry_pl<-self.__class__.plUnrlRTE*1.5):
