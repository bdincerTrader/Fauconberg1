...
class Gr8Script91158660ff374a79bb5d45a9e98d5131(Strategy):
    __script_name__ = 'cmgFauconberg'
    ...
    def is_symbol_qualified(cls, symbol, md, service, account):
        return symbol in Gr8Script91158660ff374a79bb5d45a9e98d5131.tickerItrB;
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        if(self.systemStatus==1):
            self.satisfied=0;
            self.bot=self.long=0;
            self.sold=self.short=0;
            self.orderSession=0;
            self.orderBalance=0;
            order.cancel(self.symbol);
            self.systemStatus=0;
        ...
        if(self.key==1 and event.timestamp<self.illiquid_time): 
            ...
            if(self.ebft<0 and s>=3):
                ...
                self.sysTwo[self.orderItr][12]=self.long;
                self.sysTwo[self.orderItr][13]=self.short;
                ...
                while(pendingOrderUnit>0):
                    ...
                    if(caseOrder.shares<0):
                        ...
                        self.sysTwo[self.orderItr][17]+=caseOrder.price;
                        ...
                        pass;
                    if(caseOrder.shares>0):
                        self.sysTwo[self.orderItr][18]+=1;
                        self.sysTwo[self.orderItr][19]+=caseOrder.shares;
                        self.sysTwo[self.orderItr][20]+=caseOrder.price;
                ...
                self.sysTwo[self.orderItr][21]=md.L1.bid;
                self.sysTwo[self.orderItr][22]=md.L1.ask;
                self.sysTwo[self.orderItr][23]=md.L1.last;
                ...
                if(len(self.systemDOWN)>1 and s>=4):
                    ...
                    self.sysTwo[self.orderItr][24]=long_bal;
                    self.sysTwo[self.orderItr][25]=statusShort;
                    self.sysTwo[self.orderItr][26]=statusUpdate;
                    self.sysTwo[self.orderItr][27]=self.bot+self.sold;
                    self.sysTwo[self.orderItr][28]=self.long+self.sold;
                    self.sysTwo[self.orderItr][29]=account[self.symbol].position.mtm_price;
                    self.sysTwo[self.orderItr][30]=self.satisfied;
                    self.sysTwo[self.orderItr][31]=account.realized_mtm_pl;
                    self.sysTwo[self.orderItr][32]=account.unrealized_entry_pl;
            ...
            if(self.ebft>0 and (self.ATR_scRp+self.mot_scRp+self.xxl_scRp)>=3):
                self.systemLong=1;
                ...
                if(self.sysTwo[self.orderItr][15]>0):    
                    net_ask_px=self.sysTwo[self.orderItr][17]/self.sysTwo[self.orderItr][15];
                    self.sysTwo[self.orderItr][17]=net_ask_px;
                    pass;
                    
                if(self.sysTwo[self.orderItr][18]>0):
                    net_bid_px=self.sysTwo[self.orderItr][20]/self.sysTwo[self.orderItr][18];
                    self.sysTwo[self.orderItr][20]=self.sysTwo[self.orderItr][20]/self.sysTwo[self.orderItr][18];
                    pass;
                ...
                if(len(self.systemUP)>1):
                    statusLong=self.orderBalance-(self.short+self.long);
                    statusUpdate=0;
                    statusUpdate=-statusLong;

                    self.sysTwo[self.orderItr][24]='short_bal';
                    self.sysTwo[self.orderItr][25]=statusLong;
                    self.sysTwo[self.orderItr][26]=statusUpdate;
                    self.sysTwo[self.orderItr][27]=self.bot+self.sold;
                    self.sysTwo[self.orderItr][28]=self.long+self.sold;
                    self.sysTwo[self.orderItr][29]=account[self.symbol].position.mtm_price;
            ...
            if(self.orderSession>0 and self.ebft==0):
                ...
                self.sysTwo[self.orderItr][22]=md.L1.ask;
                self.sysTwo[self.orderItr][23]=md.L1.last;
                self.sysTwo[self.orderItr][24]='session over'
                self.sysTwo[self.orderItr][25]='session over'
                self.sysTwo[self.orderItr][26]='session over'
                self.sysTwo[self.orderItr][27]=self.bot+self.sold;
                self.sysTwo[self.orderItr][28]=self.long+self.sold;
                self.sysTwo[self.orderItr][29]=account[self.symbol].position.mtm_price
                self.sysTwo[self.orderItr][30]=self.satisfied;
    ...
    def on_finish(self, md, order, service, account):
        for units in self.sysOne:
            service.write_file('textfile.txt','{}'.format(units))  
        return;
