...
class Gr8Script17b09ac5f7834bbcba0a0f40e2eb1ec5(Strategy):
    ...
    def on_start(self, md, order, service, account):
        ...
        self.limitBP=0;
        # USES [ maxSymbolTrade ] TO SET THE MAX ORDER QTY.
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        # postBB = order.algo_buy(self.symbol, algorithm='9e6b50d6-dee3-4314-a43b-49e9ae8088b6', intent='increase', order_quantity=1, user_key=212, allow_multiple_pending=40);
