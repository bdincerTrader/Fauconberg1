...
class Gr8Scriptc0bc5fc591bd4bfd9a11196cace13ea2(Strategy):
    ...
    def is_symbol_qualified(cls, symbol, md, service, account):
        ...
        #return symbol in Gr8Scriptc0bc5fc591bd4bfd9a11196cace13ea2.tickerItrB;
    ...
    def on_timer(self, event, md, order, service, account):
        ...
        if(self.key==1 and event.timestamp<self.illiquid_time): 
            ...
            if(self.ebft<0):
                ...
                if(len(self.systemDOWN)>1 and s>=2):
            ...
            if(self.ebft>0):
                ...
                # CAPTURE SPREADS.
                if(account[self.symbol].unrealized_pl.entry_pl>5000):
                    return order.algo_sell(self.symbol, algorithm='8fa5330d-b32d-4083-86eb-d9a61a637b8b', intent='decrease', order_quantity=abs(account[self.symbol].position.shares), user_key=999, allow_multiple_pending=True);
                if(account[self.symbol].unrealized_pl.entry_pl>2500):
                    return order.algo_buy(self.symbol, algorithm='9e6b50d6-dee3-4314-a43b-49e9ae8088b6', intent='decrease', order_quantity=abs(account[self.symbol].position.shares), user_key=999, allow_multiple_pending=True);
