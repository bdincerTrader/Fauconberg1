    ...
    def on_timer(self, event, md, order, service, account):
        ...
        for idx in range(0, rangeM, 1):
            ...
            for _idx in range(offset+1, offset-8, -1):
                self.dataBookMS[self.itr][bSeries]=self.dataPt[_idx][6];
                print(_idx, hSeries, self.dataBookMS[self.itr][bSeries]);
                bSeries+=1;
            ...
            print('[17:27]\t BID PRICE\t\t', lSeries, self.dataBookMS[self.itr][17:28]); 
            ...
            print('[28:38]\t LAST PRICE\t\t', lSeries, self.dataBookMS[self.itr][28:39]); 
            ...
            print('[39:49]\t ASK PRICE\t\t', aSeries, self.dataBookMS[self.itr][39:50]); 
            
            mSeries=51;                                                                                    #MIDPX
            for _idx in range(offset+1, offset-8, -1):
                self.dataBookMS[self.itr][mSeries]=self.dataPt[_idx][16];
                print(_idx, hSeries, self.dataBookMS[self.itr][mSeries]);
                mSeries+=1;
            ...
            print('[51:61]\t BID/ASK SPR\t\t', mSeries, self.dataBookMS[self.itr][51:62]); 
            ...
            print('[62:72]\t BID/ASK SPR\t\t', baSeries, self.dataBookMS[self.itr][62:73]); 
            ...
            print('[73:83]\t INTERVAL HIGH\t\t', hSeries, self.dataBookMS[self.itr][73:84]);
            ...
            print('[84:94]\t INTERVAL LOW:\t\t', lSeries, self.dataBookMS[self.itr][84:95]);

            hlSeries=95;                                                                                    #High_LOW SPREAD
            for _idx in range(offset+1, offset-8, -1):
                self.dataBookMS[self.itr][hlSeries]=barA.low[_idx];
                hlSeries+=1;
            ...
            print('[95:105]\t High_Low_Spread:\t', hlSeries, self.dataBookMS[self.itr][95:106]);
            ...
            print('[106:116]\t Range Number 1:\t', r1, self.dataBookMS[self.itr][106:117]);
            ...
            print('[117:127]\t Range Number 2:\t', r2, self.dataBookMS[self.itr][117:128]);
            ...
            print('[117:138]\t Range Number 3:\t', r3, self.dataBookMS[self.itr][117:139]);
            ...
            print('[139:149]\t Range Number 4:\t', r4, self.dataBookMS[self.itr][139:150]);
            ...
            if(self.idxLoop>10 and idx==rangeM-2):
                ...
                # check current bar equal to local max or min. 
